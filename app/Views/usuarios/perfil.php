                ...
                <div class="col col-lg-9 col-xl-7">
                    <div class="card">
                        <div class="rounded-top text-white d-flex flex-row" style="background-color: black; height:200px;">
                            <div class="ms-4 mt-5 d-flex flex-column" style="width: 150px;background-color: black;border-radius: 50%;">
                                <img src="<?php echo base_url('/img/usuario.png') ?>" alt="Generic placeholder image" class="img-fluid img-thumbnail mt-4 mb-2" style="width: 150px;z-index: 1;background-color: black;border:  none;border-radius: 50%;">
