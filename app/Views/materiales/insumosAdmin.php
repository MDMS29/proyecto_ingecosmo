...
<div id="content" class="p-4 p-md-5" style="background-color:rgba(0, 0, 0, 0.05);">
    ...
    <div class="table-responsive p-2">
        <div class="d-flex justify-content-center align-items-center flex-wrap ocultar">
            <b class="fs-6 text-black"> Ocultar Columnas:</b> <a class="toggle-vis btn" data-column="0">#</a>  - <a class="toggle-vis btn" data-column="2">Categoria del Insumo</a>  - <a class="toggle-vis btn" data-column="3">Tipo de material</a> 
        </div>
