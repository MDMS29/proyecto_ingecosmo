            ...
            },
            {
                ...
                render: function(data, type, row) {
                    return (
                        ...
                        '<button class="btn" data-href=<?php echo base_url('/aliados/cambiarEstado/') ?>' + data.id_tercero + '/A data-bs-toggle="modal" data-bs-target="#modalConfirmar"><img src="<?php echo base_url("icons/restore.png") ?>" alt="Boton Eliminar" title="Eliminar Aliado" width="20"></button>'
                    );
                },
            }
        ],
