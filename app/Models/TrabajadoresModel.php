...
class TrabajadoresModel extends Model
{
    ...
    protected $allowedFields = ['id_rol', 'tipo_doc', 'n_identificacion', 'nombre_p', 'nombre_s', 'apellido_p', 'apellido_s', 'contrasena', 'estado', 'fecha_crea', 'usuario_crea']; /* relacion de campos de la tabla */
