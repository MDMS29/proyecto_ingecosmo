...
class OrdenesModel extends Model
{
    ...
    protected $allowedFields = ['n_orden', 'id_vehiculo', 'nombres', 'apellidos', 'n_identificacion', 'llaves', 'documentos','grua', 'estado', 'fecha_entrada', 'fecha_salida', 'fecha_crea', 'usuario_crea']; /* relacion de campos de la tabla */
